...
#ifndef __AI_TF_MODEL_H__
#define __AI_TF_MODEL_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_TF_MODEL_MODEL_NAME          "tf_model"

#define AI_TF_MODEL_IN_NUM       (1)
#define AI_TF_MODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 6, 1, NULL), \
}
#define AI_TF_MODEL_IN_SIZE { \
  (1 * 1 * 6), \
}
#define AI_TF_MODEL_IN_1_SIZE  (1 * 1 * 6)
#define AI_TF_MODEL_IN_1_SIZE_BYTES  ((1 * 1 * 6) * 4)




#define AI_TF_MODEL_OUT_NUM      (1)
#define AI_TF_MODEL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 26, 1, NULL), \
}
#define AI_TF_MODEL_OUT_SIZE { \
  (1 * 1 * 26), \
}
#define AI_TF_MODEL_OUT_1_SIZE  (1 * 1 * 26)
#define AI_TF_MODEL_OUT_1_SIZE_BYTES  ((1 * 1 * 26) * 4)

#define AI_TF_MODEL_N_NODES (6)
 ...
 * @ref ai_tf_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_tf_model_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_TF_MODEL_*
 * defines into file @ref tf_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tf_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_TF_MODEL_H__*/
